...
public class ItemRegister {
    public static final Item MYSTERIOUS_ORB = new ItemMysteriousOrb(new FabricItemSettings().group(PsychicSpoonMod.PSYCHIC_SPOON_GROUP).maxCount(1));
    public static final Item DISCOVERED_ORB = new ItemDiscoveredOrb(new FabricItemSettings().group(PsychicSpoonMod.PSYCHIC_SPOON_GROUP).maxCount(1));
